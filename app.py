...
if submitted:
    ...
    progress.progress(30, text="Consultando PageSpeed (desktop)...")
    ps_desktop = get_pagespeed(url, "desktop")

    progress.progress(55, text="Baixando HTML do site...")
    try:
        html = fetch_html(url)
        html_ok = True
    ...
    progress.progress(70, text="Detectando tags e formulários...")
    if html_ok:
    ...
    progress.progress(85, text="Checando usabilidade...")
