...
import sys
import re
from analyzer import get_pagespeed, fetch_html, detect_tags, detect_forms, detect_usability_issues
...
def main():
    ...
    print("  [1/5] PageSpeed mobile...")
    ps_mobile = get_pagespeed(url, "mobile")

    print("  [2/5] PageSpeed desktop...")
    ps_desktop = get_pagespeed(url, "desktop")

    print("  [3/5] Baixando HTML...")
    try:
        html = fetch_html(url)
    ...
    print("  [4/5] Detectando tags e formulários...")
    tags = detect_tags(html) if html else {"gtm_containers": [], "ga4_properties": [], "google_ads_ids": [],
    ...
    print("  [5/5] Checando usabilidade...")
